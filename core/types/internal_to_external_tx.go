...
func (tx *InternalToExternalTx) txIn() TxIns               { panic("internal TX does not have txIn") }
func (tx *InternalToExternalTx) txOut() TxOuts             { panic("internal TX does not have txOut") }
func (tx *InternalToExternalTx) utxoSignature() *schnorr.Signature {
