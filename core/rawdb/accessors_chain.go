...
func ReadCoinbaseLockup(db ethdb.KeyValueReader, batch ethdb.Batch, ownerContract common.Address, beneficiaryMiner common.Address, lockupByte byte, epoch uint32) (*big.Int, uint32, uint16) {
	...
	if deleted {
		...
		return amount, blockHeight, elements
	}
...
func WriteCoinbaseLockup(db ethdb.KeyValueWriter, ownerContract common.Address, beneficiaryMiner common.Address, lockupByte byte, epoch uint32, amount *big.Int, blockHeight uint32, elements uint16) ([]byte, error) {
	data := make([]byte, 38)
...
func DeleteCoinbaseLockup(db ethdb.KeyValueWriter, ownerContract common.Address, beneficiaryMiner common.Address, lockupByte byte, epoch uint32) {
	if err := db.Delete(CoinbaseLockupKey(ownerContract, beneficiaryMiner, lockupByte, epoch)); err != nil {
