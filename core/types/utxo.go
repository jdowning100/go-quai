...
func CoinbaseLockupHash(ownerContract common.Address, beneficiaryMiner common.Address, lockupByte byte, epoch uint32, balance *big.Int, unlockHeight uint32, elements uint16) common.Hash {
	return RlpHash([]interface{}{ownerContract, beneficiaryMiner, lockupByte, epoch, balance, unlockHeight, elements}) // TODO: Consider encoding to protobuf instead
}
