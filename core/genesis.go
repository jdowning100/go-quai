...
type GenesisAlloc map[common.Address]genallocs.GenesisAccount

func (ga *GenesisAlloc) UnmarshalJSON(data []byte) error {
	m := make(map[common.UnprefixedAddress]genallocs.GenesisAccount)
...
type genesisSpecMarshaling struct {
	...
	Alloc      map[common.UnprefixedAddress]genallocs.GenesisAccount
}
